...
<LinkButtons
  githubUrl="https://github.com/pytorch/botorch/blob/v0.17.0/tutorials/optimize_stochastic/optimize_stochastic.ipynb"
  colabUrl="https://colab.research.google.com/github/pytorch/botorch/blob/v0.17.0/tutorials/optimize_stochastic/optimize_stochastic.ipynb"
/>
...
As discussed in the [CMA-ES tutorial](./optimize_with_cmaes), for deterministic
